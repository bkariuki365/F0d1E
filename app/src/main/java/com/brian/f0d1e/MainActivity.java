...
import com.brian.f0d1e.Adapter.MyAdapter;
import com.brian.f0d1e.Model.Recipe;
import com.brian.f0d1e.Model.RecipiesResponse;
import com.brian.f0d1e.Retrofit.ApiClient;
import com.brian.f0d1e.Retrofit.ApiInterface;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private final static String API_KEY = "0221d2effea3471fb0dc52e02172c049";
